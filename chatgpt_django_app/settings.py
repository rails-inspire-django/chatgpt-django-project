"""
Django settings for chatgpt_django_app project.
...
SECRET_KEY = 'django-insecure-j6gmabhdnblwb9^yq(#a_!3q-h8fmqm4w*3c1166ljyr81l^6q'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['chatgpt_django_app/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# WSGI_APPLICATION = 'chatgpt_django_app.wsgi.application'
ASGI_APPLICATION = 'chatgpt_django_app.asgi.application'
